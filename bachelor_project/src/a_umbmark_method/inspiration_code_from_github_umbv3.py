...
#    # Normalize goal angle to [-180, 180]
#    goalangle = normalize_angle(goalangle)
...
#        error = normalize_angle(goalangle - cangle)
#        if abs(error) < tolerance:
#            move_cmd.angular.z = 0.0
#            pub.publish(move_cmd)
#            print("Turn complete. Current angle: {}, Goal angle: {}".format(cangle, goalangle))
#            break
#        # Proportional controller for angular speed
#        move_cmd.angular.z = 0.5 * math.radians(error)
#        pub.publish(move_cmd)
#        rate.sleep()
...
def turn(a):
    ...
    while True:
        ...
        if (rjk>0):
            currentangle=cangle
            move_cmd.angular.z =(goalangle-currentangle)*1.5*math.pi/180
            pub.publish(move_cmd)
